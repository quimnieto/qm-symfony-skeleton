 ...
 */
class getRouting_LoaderService extends Qm_Apps_Backoffice_Backend_BackofficeBackendKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'kernel' => 'Qm\\Apps\\Backoffice\\Backend\\BackofficeBackendKernel',
        ]), 'dev'));
        $a->addLoader($c);
